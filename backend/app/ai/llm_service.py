...
class LLMCommandService:
    ...
    def parse_command(self, transcript: str) -> ParsedCommand:
        ...
        if self.groq_client:
            try:
                ...
                logger.error(f"Groq API parsing failed, falling back to rule parser: {e}")
    ...
    def _fallback_rule_parser(self, transcript: str) -> ParsedCommand:
        ...
        # Strip leading action keyword if present
        ...
        # Split text into item segments by comma, ' and ', semicolon
    ...
    def _parse_segment_to_item(self, segment: str):
        ...
        # Extract unit (packets, bottles, kg, pieces, packs, etc.)
        ...
        # Default unit for eggs if quantity > 1 and no unit explicitly mentioned
